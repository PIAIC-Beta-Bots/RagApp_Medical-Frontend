...
import { useRouter } from 'next/navigation'; // Update for Next.js 14
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || "Signup failed. Please try again."; // Improved error handling
    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10 p-8 pt-8">
          ...
          <h2 className="text-lg text-center text-gray-600 pt-4 mb-6">Create Your Account</h2>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="flex items-center bg-gray-100 rounded-lg p-3">
              ...
              <input
                ...
                placeholder="Name"
                value={username} // Corrected to use username
          ...
          <p className="text-center mt-6 text-sm text-gray-600">
            Already Have an Account? <Link href="/login" className="text-green-600 font-semibold hover:underline">Login Now</Link>
          </p>
        </div>
      </div>
    </div>
